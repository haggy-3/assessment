...
assessmentButton.onclick = () => {
    ...
    const result = assessment(userName); //診断結果を出す
    const header = document.createElement('h3'); //h3タグを生成
    header.innerText = '診断結果'; //header
...
/**
 * IMEで半角エンターキーが入力された場合に実行
 * @param event userNamenameInputの要素
 */
